...
<div class="container">  
                <div class="row">  
                    <div class="col-md-5 mx-auto">  
                      ...
                      <form id="submitForm" action="std_info_insert_operation.php" method="post" data-parsley-validate="" data-parsley-errors-messages-disabled="true" novalidate="" _lpchecked="1">  
...
<input type="number" class="form-control" required="" id="ph" name="ph" value="">  
       </div>  
