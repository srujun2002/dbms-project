...
<body>
<div class="pt-5">  
  <h1 class="text-center">Read  sub data </h1>  
<div class="container">  
                <div class="row">  
                    <div class="col-md-5 mx-auto">  
                        <div class="card card-body">  
                      <form id="submitForm" action="std_subject_search.php" method="post" data-parsley-validate="" data-parsley-errors-messages-disabled="true" novalidate="" _lpchecked="1">  
...
<table class="table">
  ...
  $con=create_connection();
   $query="select * from subject where sub_id like '%$search_value%'";
