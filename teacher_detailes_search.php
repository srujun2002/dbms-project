...
<div class="container">  
                <div class="row">  
                    <div class="col-md-5 mx-auto">  
                      ...
                      <form id="submitForm" action="teacher_detailes_search.php" method="post" data-parsley-validate="" data-parsley-errors-messages-disabled="true" novalidate="" _lpchecked="1">  
...
<table class="table">
  ...
  $con=create_connection();
   $query="select * from teacher_detailes where teacher_id like '%$search_value%'";
   ...
   while($row=mysqli_fetch_array($result)){
     ?>
		...
		<tr>
			...
			<td> <?php echo $row['teacher_phno'] ;?> </td>
