...
<body>  
<div class="pt-5">  
  <h1 class="text-center">INSERT TIME TABLE DETAILES </h1>  
<div class="container">  
                <div class="row">  
                    <div class="col-md-5 mx-auto">  
                        <div class="card card-body">  
                      <form id="submitForm" action="time_table_insert_operation.php" method="post" data-parsley-validate="" data-parsley-errors-messages-disabled="true" novalidate="" _lpchecked="1">  
       ...
       <div class="form-group required">  
    <label class="d-flex flex-row align-items-center" for="start_time">start_time   
     </label>  
...
<div class="form-group required">  
    <label class="d-flex flex-row align-items-center" for="end_time">end_time
     </label>  
...
<input type="number" class="form-control" required="" id="sub_id" name="sub_id" value="">  
       ...
       <div class="form-group required">  
    <label class="d-flex flex-row align-items-center" for="acad_year">acad_year 
     </label>  
