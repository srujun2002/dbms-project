...
<div class="container">  
                <div class="row">  
                    <div class="col-md-5 mx-auto">  
                      ...
                      <form id="submitForm" action="sub_teacher_delete_operation.php" method="post" data-parsley-validate="" data-parsley-errors-messages-disabled="true" novalidate="" _lpchecked="1">  
